      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center space-x-2">
            <Image src="/icon.png" alt="PrivAI Logo" width={32} height={32} />
          ...
          <button
            type="button"
            className="md:hidden inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-sky-400 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-sky-500"
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link 
              ...
              className="text-gray-300 hover:text-sky-400 transition-colors relative group"
            >
              Intro
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-sky-400 group-hover:w-full transition-all duration-300" />
            </Link>
            <Link 
              href="#core-highlights" 
              onClick={(e) => handleScroll(e, 'core-highlights')}
              className="text-gray-300 hover:text-sky-400 transition-colors relative group"
            >
              Core Highlights
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-sky-400 group-hover:w-full transition-all duration-300" />
        ...
        <div className={`md:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
          <div className="px-2 pt-2 pb-3 space-y-1 bg-gray-900/95 backdrop-blur-sm rounded-lg mt-2 border border-gray-800">
            <Link 
              href="#intro" 
              onClick={(e) => handleScroll(e, 'intro')}
              className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-sky-400 hover:bg-gray-800 transition-colors"
            >
              Intro
            </Link>
            <Link 
