...
/**
 * Footer Component
 * Displays the site footer with logo, navigation, social links, and copyright
 * 
 * @component
 */
const Footer = () => {
  const menuItems = [
    ...
    { label: 'Core Highlights', href: '#core-highlights' },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-md">
              PrivAI is a decentralized platform that integrates AI, TEE, and MCP to deliver secure, 
              privacy-controlled services and automated Web3 operations.
            </p>
          </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                social.href ? (
                  ...
                  <span
                    key={social.name}
                    className="text-gray-400 cursor-default" // 注意去掉了 hover 效果
                    title={social.name}
                  >
                    {social.icon}
                  </span>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-gray-400 text-sm text-center">
            © {new Date().getFullYear()} PrivAI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
